...
This repo's first objective is to obtain feedback from the vehicule's potentiometer attached to it's atriculation. To accomplsh that the stm32 based Nucleo-F303k8MCU was used you can find the ralated code in the serial steering folder
