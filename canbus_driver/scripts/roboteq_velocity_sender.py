...
class RoboteqVelocitySender(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info(
            ...
            f"  Send : ros2 topic pub /cmd_ch1 std_msgs/msg/Int32 '{{data: 500}}'\n"
            f"  Read : ros2 topic echo /articulation/sensor/yaw"
        )
    ...
    def _send_velocity(self) -> None:
        ...
        """
        # Watchdog: zero the motor if topic has gone silent
        stale = (
